...
ACGN 公开资料博客 MVP，包含 Vue 3 前端、Express API、Prisma ORM 和线上 MySQL 数据库。当前重点功能包括公开来源文章、开放授权画廊、Live2D 小人、用户空间、后台管理、首页轮播和富文本编辑。
...
- 发现页、开放授权画廊、ACGN 公开资料入口和 Live2D 小人
