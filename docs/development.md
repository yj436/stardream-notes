...
- `src/views/AdminView.vue` is the largest page. Next refactor should extract admin navigation, KPI cards, carousel editor, report table, backup panel, and system health panel.
...
| --- | --- | --- |
| P1 | Admin page | Extract admin subcomponents and reduce `AdminView.vue` to route orchestration. |
